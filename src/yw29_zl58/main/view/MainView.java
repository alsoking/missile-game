...
public class MainView extends JFrame {
	...
	private final JButton btnLetHimShow = new JButton("Let them show map");
	...
	/**
	 * create the frame 
	 * @param _view2modelAdpt the adapter
	 */
	...
	private void initGUI() {
		...
		GridBagConstraints gbc_btnLetHimShow = new GridBagConstraints();
		gbc_btnLetHimShow.insets = new Insets(0, 0, 5, 0);
		gbc_btnLetHimShow.gridx = 0;
		gbc_btnLetHimShow.gridy = 1;
		btnLetHimShow.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {

				view2modelAdpt.sendGameView(FriendsComboBox1.getItemAt(FriendsComboBox1.getSelectedIndex()));
			}
		});
		panel_5.add(btnLetHimShow, gbc_btnLetHimShow);
	...
	/**
	 * the friend to add
	 * @param friend the Iuser of the new friend
	 */

...
public class GameTaskCmd extends DataPacketUserAlgoCmd<GameTaskType>{
	...
	@Override
	public String apply(Class<?> index, DataPacketUser<GameTaskType> host, String... params) {
		...
		view.displayTask(host.getData().getTask());
		return null;
	}

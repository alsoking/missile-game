...
public class ScoreCmd extends DataPacketUserAlgoCmd<ScoreType>{
	/**
	 * 
	 */
	...
	@Override
	public String apply(Class<?> index, DataPacketUser<ScoreType> host, String... params) {
		...
		view.displayTeamASore(Integer.toString(host.getData().getScoreA()));

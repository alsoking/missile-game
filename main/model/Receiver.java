...
import yw29_zl58.main.model.cmds.FileCmd;
import yw29_zl58.main.model.cmds.ImageCommand;
import yw29_zl58.main.model.cmds.StringCommand;
import yw29_zl58.main.model.data.ExceptionType;
...
import yw29_zl58.main.model.data.InstallCmdType;
...
public class Receiver implements IReceiver {
		...
		dataPacketAlgo.setCmd(IRequestCmdType.class, new DataPacketCRAlgoCmd<IRequestCmdType>() {
			...
			public String apply(Class<?> index, DataPacketCR<IRequestCmdType> host, String... params) {
				...
				try {
					...
					sender.receive(new DataPacketCR<ICRInstallCmdType>(ICRInstallCmdType.class,new InstallCmdType(id,cmd),localReceiverStub));
				} catch (RemoteException e) {
					System.out.println("Exception when sending datapacket to the sender");
					e.printStackTrace();
				}
	 ...
	 * @param stub the stub of the receiver
	 */
